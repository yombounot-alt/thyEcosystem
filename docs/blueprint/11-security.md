...
| Périodique | **Test d'intrusion externe** avant le jalon « public v1 » (fin Phase 4) et avant Phase 11 ; programme de divulgation (`security.txt`), _bug bounty_ ultérieur |
