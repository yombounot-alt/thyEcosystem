...
2. **Le serveur applique**, le mobile ne fait que *masquer/afficher* (`GET /me/entitlements`, mis en cache avec date d'expiration).
...
6. **Statut des stores** : les abonnements/contenus **numériques** vendus *dans* l'app peuvent relever des règles de facturation d'Apple/Google — **à trancher avant la Phase 10** (risque R9).
