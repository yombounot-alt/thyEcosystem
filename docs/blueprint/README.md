...
2. **Trois classes de données** : *tenant-privées* (Business, isolées par RLS), *user-privées* (Money, IA, candidatures) et *publiques/partagées* (annonces, profils). Chaque table appartient à une seule classe.
