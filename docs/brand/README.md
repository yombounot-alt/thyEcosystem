...
- **Autres éléments à produire par le designer**, indépendamment du vectoriel : **lockup maître « THY »** seul (sans « Business ») pour l'écran d'accueil/splash/nom de l'app — « THY | Business » reste le lockup du module Business ; **police de marque** à confirmer (hypothèse retenue : sans-serif géométrique type *Montserrat*, à valider).
