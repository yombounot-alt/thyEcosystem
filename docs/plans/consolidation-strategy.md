...
#### Statut du portage backend (2026-09-23) — ✅ terminé et vérifié
...
- **Tests** : les 6 suites e2e de thyBusiness portées sur vitest (`backend/test/business/`, 118 tests, dont paiements manuels et idempotence concurrente) + suites du kernel (`backend/test/kernel/` : auth/OTP/refresh, RBAC/invitations/surcharges, RLS au niveau SQL) + test anti-dérive Prisma↔SQL + 43 tests unitaires — **203 tests verts**.
- **Reste à faire pour clore §3.1** : l'app mobile (étape « App mobile » ci-dessus).
